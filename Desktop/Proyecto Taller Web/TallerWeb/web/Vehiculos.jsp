            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card-group mb-4">            
                        <h5 class="text-primary">Mantenimiento de Vehiculos</h5>
                    </div>
                    ...
                    <!-- *** Modifica *** -->
                     <%
                        ...
                        if(codigo > 0){
                            //cliente exite
                            vehiculo = logica.ObtenerUnVehiculo("Id="+id);                         
                        }else{
                            vehiculo = new EntidadVehiculos();
                     ...
                     <form action="CrearModificarVehiculos" method="post" id="AgregarModificarVehiculos">
                        <div class="form-group">
                            ...
                            <div> 
                                <label 
                                    for = "tipovehiculo" 
                                    class="control-lable">Tipo Vehículo
                                </label>
                            ...
                            <div> 
                                <label 
                                    for = "combustible" 
                                    class="control-lable">Combustible
                                </label>
                            ...
                            <div> 
                                <label 
                                    for = "transmision" 
                                    class="control-lable">Transmisión
                                </label>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    onclick="location.href='ListarVehiculos.jsp'"
                                />
                            </div> 
                        </div> 
                     </form>
    ...
    <script src="js/demo/datatables-demo.js"></script>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#AgregarModificarVehiculos").validate({
                    
                    rules:{
                        txtPlaca:{required:true,maxlength:15}
                    },
                    messages:{
                        txtPlaca:"'Placa' requerida, máximo 15 carácteres"              
                    },
                    errorElement:'span'
