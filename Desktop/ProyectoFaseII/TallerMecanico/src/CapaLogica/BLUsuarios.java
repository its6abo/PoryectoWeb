...
public class BLUsuarios {
    ...
    public List<EntidadUsuarios> ListarUsuarios(String condicion) throws Exception{
        List<EntidadUsuarios> usuarios = new ArrayList();
        DAUsuarios daUsuarios;
        try {
            daUsuarios = new DAUsuarios();
            usuarios = daUsuarios.ListarUsuarios(condicion);
        } catch (Exception ex) {
            throw ex;
        }
        return usuarios;
