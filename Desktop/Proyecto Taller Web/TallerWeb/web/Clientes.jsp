            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card-group mb-4">            
                        <h5 class="text-primary">Mantenimiento de Clientes</h5>
                    </div>
                    ...
                    <!-- *** Modifica *** -->
                     <%
                        ...
                        if(codigo > 0){
                            //cliente exite
                            clientes = logica.ObtenerUnCliente("Id="+id);                         
                        }else{
                            clientes = new EntidadClientes();
                     ...
                     <form action="CrearModificarClientes" method="post" id="AgregarModificarClientes">
    ...
    <script src="js/demo/datatables-demo.js"></script>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#AgregarModificarClientes").validate({
