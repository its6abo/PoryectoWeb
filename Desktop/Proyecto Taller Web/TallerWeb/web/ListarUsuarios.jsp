            ...
            <div id="content">
                ...
                <div class="form-group">
                    ...
                    <tr>
                        ...
                        <td><%=registro.getIdPerfil()%></td>
               

                        <!--Columna para los botones -->
                        <td>
                            <!--Botón para modificar -->
                            <a href="Usuarios.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                            <a href="EliminarUsuarios?idEliminar=<%=codigo %>"> <i class="fas fa-trash-alt"></i></a> |
                        </td>
                    </tr>
                    <%}%><!--Para cerrar el for --> 
                <%
                ...
                %>
                     ...
                     <a href="Usuarios.jsp?idCrearModificar=-1" class="btn btn-primary btn-icon-split">
