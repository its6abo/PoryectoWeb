<%@page import="CapaEntidades.EntidadVehiculos"%>
<%@page import="java.util.List"%>
<%@page import="CapaLogica.BLVehiculos"%>
<!DOCTYPE html>
<html lang="es">
 ...
 <!-- *** INICIO BARRA LATERLAL *** -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="ListarVehiculos.jsp" method="post">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" id="txtnombre" name="txtnombre" value="" 
                               placeholder="Buscar por Placa" class="form-control"/>
                        &nbsp;&nbsp;
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Listar Vehiculos</h6>
                        </div>
                        <div class="card-body">
                    ...
                    <% 
                        ...
                        if(request.getParameter("txtnombre")!=null){
                            ...
                            condicion = "PLACA LIKE '%" + nombre + "%'";
                        }
                        BLVehiculos logica = new BLVehiculos();
                        List<EntidadVehiculos> datos;
                        datos = logica.ListarVehiculos(condicion);
            
                        //for para llenar la tabla
                        for (EntidadVehiculos registro:datos){
                    %>
                    ...
                    <tr>
                        ...
                        <td><%=registro.getIdTipoVehiculo()%></td>
                        <td><%=registro.getIdEstilo()%></td>
                        <td><%=registro.getIdMarca()%></td>
                        <td><%=registro.getIdTipoCombustible()%></td>
                        <td><%=registro.getIdTipoTransmision()%></td>
               

                        <!--Columna para los botones -->
                        <td>
                            <!--Botón para modificar -->
                            <a href="Vehiculos.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                            <a href="EliminarVehiculos?idEliminar=<%=codigo %>"> <i class="fas fa-trash-alt"></i></a> |
                        </td>
                    </tr>
                    <%}%><!--Para cerrar el for --> 
                <%
                ...
                %>
                     ...
                     <a href="Vehiculos.jsp?idCrearModificar=-1" class="btn btn-primary btn-icon-split">
