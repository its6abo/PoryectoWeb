<%@page import="CapaEntidades.EntidadClientes"%>
 ...
 <!-- *** INICIO BARRA LATERLAL *** -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="ListarClientes.jsp" method="post">
                <div class="form-group">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="Clientes.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                ...
                %>
                     ...
                     <a href="Clientes.jsp?idCrearModificar=-1" class="btn btn-primary btn-icon-split">
