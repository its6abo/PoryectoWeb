            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card-group mb-4">            
                        <h5 class="text-primary">Mantenimiento de Empresas</h5>
                    </div>
                    ...
                    <!-- *** Modifica *** -->
                     <%
                        ...
                        if(codigo > 0){
                            ...
                            empresa = logica.ObtenerUnaEmpresa("Id="+id);                         
                        }else{
                            empresa = new EntidadEmpresas();
                     ...
                     <form action="CrearModificarEmpresas" method="post" id="AgregarModificarEmpresas">
                        <div class="form-group">
                            ...
                            <div> 
                            <label 
                                for = "txtNombreComercial" 
                                class="control-lable">Nombre.Co
                            <input 
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    onclick="location.href='ListarEmpresas.jsp'"
                                />
                            </div> 
                        </div> 
                     </form>
    ...
    <script src="js/demo/datatables-demo.js"></script>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#AgregarModificarEmpresas").validate({
                    
                    rules:{
                        txtNombre:{required:true,maxlength:60},
                        txtNombreComercial:{required:false,maxlength:60},
                    ...
                    messages:{
                        ...
                        txtNombreComercial:"'Nombre Comercial' máximo 60 carácteres",
