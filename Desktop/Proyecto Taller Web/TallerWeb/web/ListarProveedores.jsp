<%@page import="CapaEntidades.EntidadProveedores"%>
<%@page import="java.util.List"%>
<%@page import="CapaLogica.BLProveedores"%>
<!DOCTYPE html>
<html lang="es">
 ...
 <!-- *** INICIO BARRA LATERLAL *** -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="ListarProveedores.jsp" method="post">
                <div class="form-group">
                    ...
                    <% 
                        ...
                        List<EntidadProveedores> datos;
                        datos = logica.ListarProveedor(condicion);
            
                        //for para llenar la tabla
                        for (EntidadProveedores registro:datos){
                    %>
                    ...
                    <tr>
                        ...
                        <td><%=registro.getIdTipodoc()%></td>
               

                        <!--Columna para los botones -->
                        <td>
                            <!--Botón para modificar -->
                            <a href="Proveedores.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                ...
                %>
                     ...
                     <a href="Proveedores.jsp?idCrearModificar=-1" class="btn btn-primary btn-icon-split">
