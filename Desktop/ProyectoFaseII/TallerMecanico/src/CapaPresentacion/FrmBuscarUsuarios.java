...
DefaultTableModel modelo;
    ...
    private void tblUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuariosMouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            txtDescripcion.setText(tblUsuarios.getValueAt(fila, 1).toString());
            this.dispose();
        }
    ...
    private void CargarDatos(String condicion) throws Exception {
        ...
        try {
            ...
            for (EntidadUsuarios cli : lista) {
                fila[0] = cli.getId();
                fila[1] = cli.getIdPerfil();
                fila[2] = cli.getNombre();
                fila[3] = cli.getCedula();
                fila[4] = cli.isEstado();
                fila[5] = cli.getDireccion();
                fila[6] = cli.getTelefono1();
                fila[7] = cli.getTelefono2();
                fila[8] = cli.getCorreo();
                fila[9] = cli.getFecha();
                modelo.addRow(fila);
            }
        } catch (Exception ex) {
