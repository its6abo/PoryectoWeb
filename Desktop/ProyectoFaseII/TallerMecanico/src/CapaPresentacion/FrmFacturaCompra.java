...
import CapaLogica.BLFacturasCompra;
...
public class FrmFacturaCompra extends javax.swing.JInternalFrame {
  ...
  DefaultTableModel modelo;
     ...
     */
  ArrayList<EntidadDetalleFacturaCompra> lista = new ArrayList();
    ...
    private void initComponents() {
        ...
        jTextFacturacion.setText("Facturación de Compra");
       ...
       private EntidadFacturaCompra GenerarEntidad(){
        EntidadFacturaCompra factura = new EntidadFacturaCompra();

                //mpresa.setId(Integer.parseInt(txtId.getText()));
                factura.setIdEmpresa(1);
                factura.setIdProveedor(Integer.parseInt(txtIdCliente.getText()));
   ...
   public boolean validarExistencia(int idProducto){
       ...
       boolean ok = false;
       for (EntidadDetalleFacturaCompra det : lista) {
    ...
    private void btnAgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarProductoActionPerformed
        ...
        if(!txtIdProducto.getText().equals("") && !txtCantidad.getText().equals("")  )
        {
            if(isNumeric(txtCantidad.getText()))
            {
                ...
                {
                    LimpiarTabla();
                    EntidadDetalleFacturaCompra detalle = new EntidadDetalleFacturaCompra();

                    detalle.setIdProducto(Integer.parseInt(txtIdProducto.getText()));
                    detalle.setCantidad(Float.parseFloat(txtCantidad.getText()));
                    detalle.setPrecioCompra(Float.parseFloat(txtPrecio.getText()));
                    ...
                    {
                        Integer cont = 0;
                        ArrayList<EntidadDetalleFacturaCompra> lista2 = lista;
                        for (EntidadDetalleFacturaCompra det : lista2) {
    ...
    private void btnGenerarFacturaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarFacturaActionPerformed
        ...
        if(!txtIdCliente.getText().equals("")){
            ...
            if(lista.size() >= 1){
                BLFacturasCompra logica = new BLFacturasCompra();
                EntidadFacturaCompra factura = GenerarEntidad();
                try {
