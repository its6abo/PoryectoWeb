            ...
            <div class="row">
                <div class="col-md-6 mx-auto">
                    <div class="card-group mb-4">            
                        <h5 class="text-primary">Mantenimiento de Proveedores</h5>
                    </div>
                    ...
                    <!-- *** Modifica *** -->
                     <%
                        ...
                        if(codigo > 0){
                            //cliente exite
                            proveedor = logica.ObtenerUnProveedor("Id="+id);                         
                        }else{
                            proveedor = new EntidadProveedores();
                     ...
                     <form action="CrearModificarProveedores" method="post" id="AgregarModificarProveedores">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input 
                                    ...
                                    onclick="location.href='ListarClientes.jsp'"
                                />
                            </div> 
                        </div> 
                     </form>
    ...
    <script src="js/demo/datatables-demo.js"></script>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#AgregarModificarProveedores").validate({
