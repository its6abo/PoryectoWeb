<%@page import="CapaEntidades.EntidadEmpresas"%>
<%@page import="java.util.List"%>
<%@page import="CapaLogica.BLEmpresas"%>
<!DOCTYPE html>
<html lang="es">
 ...
 <!-- *** INICIO BARRA LATERLAL *** -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="ListarEmpresas.jsp" method="post">
                <div class="form-group">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Listar Empresas</h6>
                        </div>
                        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td><%=registro.getNombreComercial()%></td>
                        <td><%=registro.getCedula()%></td>
                        <td><%=registro.getDireccion()%></td>
                        <td><%=registro.getTelefono1()%></td>
                        ...
                        <td>
                            ...
                            <a href="Empresas.jsp?idCrearModificar=<%=codigo%>"> <i class="fas fa-user-edit"></i></a> |
                            <!--Botón para Eliminar -->
                            <a href="EliminarEmpresas?idEliminar=<%=codigo %>"> <i class="fas fa-trash-alt"></i></a> |
                        </td>
                    </tr>
                    <%}%><!--Para cerrar el for --> 
                <%
                ...
                %>
                     ...
                     <a href="Empresas.jsp?idCrearModificar=-1" class="btn btn-primary btn-icon-split">
